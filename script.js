document.addEventListener('DOMContentLoaded', () => {
    ...
    function buildPrompt(data) {
        return `
            ...
            [작성 지침]
            1. **출처 준수**: 반드시 제공된 [참고 링크]의 본문 내용만 기초로 하여 작성하세요. 링크에 없는 정보, 있지도 않은 사실, 잘못된 내용을 절대로 지어내거나 추측하여 넣지 마세요. 만약 링크 내용을 확인할 수 없다면, 아는 범위 내에서 작성하지 말고 반드시 "참고 자료를 확인할 수 없어 작성이 어렵습니다"라고 답변하세요.
            2. **제목**: 네이버 검색(SEO)에 유리하고 클릭을 유도하는 제목 3개를 제안하세요. 제목에 핵심 키워드가 반드시 포함되어야 합니다. 단, 페르소나의 이름은 제목에 절대 포함하지 마세요.
            3. **본문**:
               - 서론-본론-결론 구조를 갖추세요.
    ...
    refineBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            const refinePrompt = `
                ...
                글을 수정하거나 내용을 추가할 때도 반드시 초기 제공된 참고 자료의 내용만 활용하세요. 사실과 다른 내용은 넣어서는 안 됩니다.
